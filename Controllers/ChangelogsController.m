...
- (void)loadView {
    ...
    [self.rebornChangelogsWebView loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:@"https://lillieh001.github.io/repo/changelogs/youtuberebornv4.html"]]];
