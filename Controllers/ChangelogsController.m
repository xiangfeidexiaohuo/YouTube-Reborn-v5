...
- (void)loadView {
    ...
    [self.rebornChangelogsWebView loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:@"https://github.com/arichorn/YouTube-Reborn/releases/latest.html"]]];
