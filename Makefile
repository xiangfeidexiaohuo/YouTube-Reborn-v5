...
YouTubeReborn_FILES = Tweak.xm $(shell find Controllers -name '*.m') $(shell find AFNetworking -name '*.m') $(shell find JailbreakDetection -name '*.m') $(shell find YouTubeExtractor -name '*.m')
