...
YouTubeReborn_FILES = Tweak.xm $(shell find Controllers -name '*.m') $(shell find Controllers -name '*.h') $(shell find AFNetworking -name '*.m') $(shell find YouTubeExtractor -name '*.m') $(shell find MBProgressHUD -name '*.m')
