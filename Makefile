...
YouTubeReborn_FRAMEWORKS = UIKit Foundation AVFoundation AVKit Photos Accelerate CoreMotion VideoToolbox
...
YouTubeReborn_CFLAGS = -Flayout/Library/Frameworks -fobjc-arc -Wno-deprecated-declarations
YouTubeReborn_LDFLAGS += -Flayout/Library/Frameworks -rpath @loader_path/Frameworks/
